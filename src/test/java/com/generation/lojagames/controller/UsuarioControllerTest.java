...
public class UsuarioControllerTest {
	...
	public LocalDate ld = LocalDate.of(2000, 12, 12);
	...
	void start() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Root", "root@root.com", "rootroot", " ", ld));
	}
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario( 0L,
				"Gabriel Rodrigues", "gabriel@email.com.br", "12345678", " ", ld));
	...
	public void naoDeveDuplicarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario( 0L,
				"Amanda Tsai", "amanda@email.com.br", "12345678", " ", ld));
	...
	public void deveAtualizarUsuario() {
		...
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario( 0L,
				"Kendal Katherine", "kendal@email.com.br", "12345678", " ", ld));
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario( 
				...
				"kendalk@email.com.br", "78945612", " ", ld));
	...
	public void deveListarTodosUsuarios() {
		...
		usuarioService.cadastrarUsuario(new Usuario( 0L,
				"Vitor Nascimento", "vitor@email.com.br", "12345678", " ", ld));
		
		usuarioService.cadastrarUsuario(new Usuario( 0L,
				"Samara Almeida", "samara@email.com.br", "12345678", " ", ld));
	...
	public void deveListarApenasUmUsuario() {
		...
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Laura Santolia", "laura_santolia@email.com.br", "laura12345", " ", ld));
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, 
			"Marisa Souza", "marisa_souza@email.com.br", "13465278", " ", ld));

		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L, 
			"", "marisa_souza@email.com.br", "13465278", " ", ld, " "));
